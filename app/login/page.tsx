...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    if (error) {
      ...
      // Ensure user_data row exists for this user
  ...
  return (
    <div className="min-h-screen flex items-center justify-center glass-background page-transition p-4">
      <div className="glass-card p-8 w-full max-w-md mx-auto animate-scale-in">
        <h1 className="text-3xl font-bold mb-6 text-center gradient-text animate-fade-in">Login</h1>
        ...
        <p className="mt-6 text-sm text-center">Don't have an account? <a href="/register" className="text-green-700 underline hover:text-green-900">Register</a></p>
      </div>
    </div>
  );
}
